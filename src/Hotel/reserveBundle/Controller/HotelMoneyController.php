...
class HotelMoneyController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        return $this->render('HotelreserveBundle:hotel_money:index.html.twig', array(
            'entities' => $entities,
        ));
    }
...
//            die(var_dump($form->getErrorsAsString()));
            if ($form->isValid()) {
                ...
                return $this->redirect($this->generateUrl('hotel_money_index'));
            }
        }

        return $this->render('HotelreserveBundle:hotel_money:new.html.twig', array(
            'entity' => $entity,
