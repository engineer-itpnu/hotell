...
class AdminMonitoringController extends Controller
{
    public function indexAction(Request $request)
    {
        ...
        return $this->render('HotelreserveBundle:admin_monitoring:index.html.twig',array(
    ...
    public function editAction(Request $request,$hotelid, $year, $month)
    {
        ...
        if($request->isMethod("post"))
        {
            ...
            return $this->redirect($this->generateUrl("admin_monitoring_index")."?hotel=$hotelid&month=$month&year=$year");
        }
        ...
        return $this->render('HotelreserveBundle:admin_monitoring:edit.html.twig',array(
            'year' => $year,
            'month' => $month,
            'hotelid' => $hotelid,
            'javaScripts' => $javaScripts
